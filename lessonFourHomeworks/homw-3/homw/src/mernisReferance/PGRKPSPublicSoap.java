...
public class PGRKPSPublicSoap
{
    ...
    public PGRKPSPublicSoap(){}

    public PGRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PGRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PGRExtendedSoapSerializationEnvelope envelope= new PGRExtendedSoapSerializationEnvelope(PGRExtendedSoapSerializationEnvelope.VER11);
