...
public class PGRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(PGRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new PGRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static PGRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static PGRDateTimeConverter dateTimeConverter = new PGRStandardDateTimeConverter();

    public PGRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public PGRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new PGRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=PGRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,PGRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=PGRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
